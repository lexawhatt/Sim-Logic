...
| `voxel_sandbox` | Two-region building prototype, dirty chunk meshes and save/load; add `--features text`. See the [known renderer limitation](examples/Voxel-Sandbox.md#renderer-limitation). |
